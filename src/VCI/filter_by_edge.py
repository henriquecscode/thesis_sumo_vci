...
if __name__ == "__main__":
    ...
    if args.config_file is None:
        config_file = "network_configs/filter_by_edge.cfg"
    else:
        config_file = args.config_file

    if args.edge_names_file is None:
        edge_names_file = "network_configs/network_road_names"
    else:
        edge_names_file = args.edge_names_file

    if args.edge_types_file is None:
        edge_types_depth_file = "network_configs/network_road_type_depth"
    else:
